    ...
    <div class="library">
        ...
        <div class="sort">
            <div
                ...
                :key="index"
            >
                <div class="sort_title">{{ item.title }}</div>
                <ul class="sort_list">
                    <li
                        class="sort_item"
                        :class="{ active: value === changeList[index] }"
                        v-for="(item1, value) in item.arrList"
                        :key="value"
                        @click="changeClass(item1, value, index)"
                    >
                        {{ item1.name }}
                    </li>
                </ul>
            ...
            <div class="sort_sele">
                <div class="sele_title">已选条件</div>
                <ul class="sele_list">
                    <li
                        class="sele_item"
                        v-for="sele in seleList"
                        :key="sele.id"
                        v-show="sele.id"
                    >
                        {{ sele.name }}
        ...
        <div class="filter">
            <el-dropdown class="filter_item">
                ...
                <template #dropdown>
                    <el-dropdown-menu>
                        <el-dropdown-item>总点击量</el-dropdown-item>
                        <el-dropdown-item>月点击</el-dropdown-item>
                        <el-dropdown-item>周点击</el-dropdown-item>
                        <el-dropdown-item>日点击</el-dropdown-item>
                    </el-dropdown-menu>
                </template>
            </el-dropdown>
            <el-dropdown class="filter_item">
                ...
                <template #dropdown>
                    <el-dropdown-menu>
                        <el-dropdown-item>用户总点击</el-dropdown-item>
                        <el-dropdown-item>用户月点击</el-dropdown-item>
                        <el-dropdown-item>用户周点击</el-dropdown-item>
                        <el-dropdown-item>用户日点击</el-dropdown-item>
                    </el-dropdown-menu>
                </template>
            </el-dropdown>
            <el-dropdown class="filter_item">
                ...
                <template #dropdown>
                    <el-dropdown-menu>
                        <el-dropdown-item>总推荐</el-dropdown-item>
                        <el-dropdown-item>月推荐</el-dropdown-item>
                        <el-dropdown-item>周推荐</el-dropdown-item>
                        <el-dropdown-item>日推荐</el-dropdown-item>
                    </el-dropdown-menu>
                </template>
            </el-dropdown>
            <span class="filter_item">总收藏</span>
            <span class="filter_item">总字数</span>
            <span class="filter_item">更新时间</span>
        </div>
        <div class="books">
            <ul class="books_list">
                <li
...
const bookList = reactive<M[]>([
    {
        bookname: '邓小平时代',
        author: '【美】傅高义 (Ezra.F.Vogel)',
        date: '2012-9-18',
        imgUrl: '/image/book_pic1.jpeg',
        summary:
    ...
    },
    {
        ...
        author: '[意] 埃莱娜·费兰特 ',
        date: '2017-4-1',
        imgUrl: '/image/book_pic12.jpeg',
        summary:
            '只有你身为女人 才会知道这些丑陋的秘密，两个女人50年的友谊和战争。如何成为那个更强大的她，又不被她战胜。那不勒斯四部曲NO.2，《我的天才女友》后续，意大利最神秘的作家费兰特，探索青年时代的激情、困惑、挣扎、背叛和失去全球畅销近千万册被翻译成40多种语言 希拉 里·克林顿、乔纳森·弗兰岑、詹姆斯·伍德、詹姆斯·弗兰科都是她的粉丝《新名字的故事》是埃莱娜·费兰特的“那不勒斯四部曲”的第二部，描述了埃莱娜和莉拉的青年时代。在她们的人生以最快的速度急遽分化的那些年里，她们共同体验了爱、失去、困惑、挣扎、嫉妒和隐蔽的破坏。莉拉在结婚当天就发现婚姻根本不是她想象的那样，她的初夜几乎是一场强奸。她带着一种强大的破坏欲介入了斯特凡诺的家族生意，似乎成为了她和埃莱娜小时候都想成为的那种女人。久未有身孕的莉拉，和埃莱娜去海边度假休养。而在伊斯基亚岛的那个夏天，改变了所有人的一生……出于对莉拉所拥有的爱情的愤怒，“我”（埃莱娜）奋力摆脱这个破败、暴力、充满宿仇的街区。“我”成了街区的第一个大学生，并和一个高级知识分子家庭的男孩订婚，甚至出版了第一本小说。“我”以胜利者的形象回到那不勒斯，却发现告别了丑陋婚姻的莉拉，在一家肉食加工厂备受屈辱地打工。当“我”发现自己的小说，其实完全窃取了莉拉交托给“我”的秘密笔记本里那些独特的力量和灵感，“我”被迫面临一个极度痛苦的问题：“我”和莉拉，到底谁离开了，又是谁留下了？',
    },
    {
        bookname: '局外人',
        author: '[法] 阿尔贝·加缪',
        date: '2010-1-18',
        imgUrl: '/image/book_pic13.jpeg',
        summary:
    ...
    },
    {
        ...
        author: '[以色列] 尤瓦尔·赫拉利',
        date: '2014-11-1',
        imgUrl: '/image/book_pic14.jpeg',
        summary:
            '《十万年前，地球上至少有六种不同的人但今日，世界舞台为什么只剩下了我们自己？从只能啃食虎狼吃剩的残骨的猿人，到跃居食物链顶端的智人，从雪维洞穴壁上的原始人手印，到阿姆斯壮踩上月球的脚印，从认知革命、农业革命，到科学革命、生物科技革命，我们如何登上世界舞台成为万物之灵的？从公元前1776年的《汉摩拉比法典》，到1776年的美国独立宣言，从帝国主义、资本主义，到自由主义、消费主义，从兽欲，到物欲，从兽性、人性，到神性我们了解自己吗？我们过得更快乐吗？我们究竟希望自己得到什么、变成什么？',
    },
    {
        bookname: '平凡的世界',
        author: '路遥',
        date: '2005-1-18',
        imgUrl: '/image/book_pic15.jpeg',
        summary:
...
const seleList = reactive<Y[]>([{}, {}, {}, {}, {}]);
const changeList = reactive<number[]>([0, 0, 0, 0, 0]);
if (route.query.id) {
    changeList[0] = Number(route.query.id);
    seleList[0] = route.query;
}
const sortList = reactive<T[]>([
    {
        title: '作品分类',
        arrList: [
            { id: 0, name: '全部分类' },
...
const changeClass = (item: Y, value: number, index: number) => {
    changeList[index] = value;
    if (item.id !== 0) {
        seleList[index] = item;
    }
};
const gotoCont = (item: M) => {
    router.push({
        name: 'content',
        query: {
            name: item.author,
...
.library {
    ...
    .top {
        ...
        position: fixed;
        top: 0;
        box-shadow: 0px 3px 3px rgb(199, 199, 199);
        z-index: 999;
    }
